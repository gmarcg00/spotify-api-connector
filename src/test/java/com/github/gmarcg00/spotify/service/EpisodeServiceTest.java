...
class EpisodeServiceTest {
    ...
    void testGetEpisodeSuccessfully() throws UnauthorizedException, EntityNotFoundException {
        //Given
        when(executor.get("7eLcDZDYHXZCebtQmVFL25","", EpisodeResponse.class)).thenReturn(TestCommonData.getEpisodeResponse());
        ...
        verify(executor,times(1)).get("7eLcDZDYHXZCebtQmVFL25","", EpisodeResponse.class);
    }
    ...
    void testGetEpisodesSuccessfully() throws UnauthorizedException, EntityNotFoundException {
        ...
        when(executor.gets(ids,"", EpisodeListResponse.class)).thenReturn(response);
        ...
        verify(executor,times(1)).gets(ids,"", EpisodeListResponse.class);
    }
}
